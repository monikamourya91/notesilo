                ...
                <div class="row gutter-20">
                    ...
                    <div class="col-md-12" style="margin-bottom:15px;">
                        <p class="alert alert-danger">
                            You account is not active. Please renew your subscription to avail the services.
                        </p>    
                    </div>
                    @endif
                        ...
                        <div class="panel">
                            ...
                            <div class="miniStats--panel">
                                ...
                                <div class="miniStats--body">
                                    ...
                                    <h3 class="miniStats--title h4">Active Subscribers</h3>
                                    <p class="miniStats--num text-blue">{{$active_subscribers}}</p>
                                </div>
                            </div>
                        ...
                        <div class="panel">
                            ...
                            <div class="miniStats--panel">
                                ...
                                <div class="miniStats--body">
                                    ...
                                    <h3 class="miniStats--title h4">Total Payment Modes</h3>
                                    <p class="miniStats--num text-orange">{{$gateways}}</p>
                                </div>
                            </div>
                            <!-- Mini Stats Panel End -->
                        </div>
                        ...
                        <div class="panel">
                            ...
                            <div class="miniStats--panel">
                                ...
                                <div class="miniStats--body">
                                    ...
                                    <h3 class="miniStats--title h4">Active Plans</h3>
                                    <p class="miniStats--num text-green">{{$active_plans}}</p>
                                </div>
                            </div>
                            <!-- Mini Stats Panel End -->
                        </div>
                    ...
                    <div class="col-xl-9">
                        <div class="panel">
                            ...
                            <form id="uploadForm">  
                                 ...
                                 <div class="col-md-4">  
                                      <input name="uploadimage[]" type="file" multiple />  
                                 </div>  
                                 <div class="col-md-4">  
